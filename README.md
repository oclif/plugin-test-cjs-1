...
running command...
$ cjs1 (--version)
@oclif/plugin-test-cjs-1/0.7.70 linux-x64 node-v20.19.2
$ cjs1 --help [COMMAND]
USAGE
  $ cjs1 COMMAND
...
...
_See code: [src/commands/cjs1.ts](https://github.com/oclif/plugin-test-cjs-1/blob/0.7.70/src/commands/cjs1.ts)_
